...
Revision ID: 3792660151ef
Revises: 
Create Date: 2021-07-14 20:41:19.323034
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['product_id'], ['product.id'], ),
    sa.ForeignKeyConstraint(['shopping_list_id'], ['shopping_list.id'], name='_fk_shopping_list_id', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('shopping_list_id', 'product_id', name='_uc_shopping_list_id_product_id')
    )
